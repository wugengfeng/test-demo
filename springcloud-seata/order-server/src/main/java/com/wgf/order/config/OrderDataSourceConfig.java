 ...
 **/
@Configuration
@MapperScan(basePackages = {OrderDataSourceConfig.BASE_PACKAGES}, sqlSessionTemplateRef = "orderSqlSessionTemplate")
public class OrderDataSourceConfig {

    public final static String BASE_PACKAGES = "com.wgf.order.mapper";
    ...
    @Bean
    public MapperHelper orderMapperHelper(@Qualifier("orderSqlSessionFactory") SqlSessionFactory sqlSessionFactory) {
